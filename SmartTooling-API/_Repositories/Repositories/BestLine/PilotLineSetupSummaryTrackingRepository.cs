...
{
    public class PilotLineSetupSummaryTrackingRepository: MainRepository<Pilot_Line_Setup_Summary_Tracking>, IPilotLineSetupSummaryTrackingRepository
    {
        private readonly DataContext _context;
        public PilotLineSetupSummaryTrackingRepository(DataContext context, CBDataContext CBcontext, SHCDataContext SHCcontext,
